...
def test_structural_geometry_2d_validate_rejects_duplicate_node_ids() -> None:
...
def test_structural_geometry_2d_validate_rejects_duplicate_member_ids() -> None:
    model = StructuralGeometry2D(
        "Frame1",
